    ...
    <div class="row sticky-top">
        <div class="top-menu bg-dark">
            <div class="d-inline float-strat">
                ...
                <a class="nav-link d-inline ps-0 pe-0" href="{{url('/c_dashboard')}}">
            ...
            <div class="d-inline float-end">
                <div class="dropdown d-inline">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                        ...
                        <li><a class="dropdown-item" href="{{url('/c_view_new',$item->id)}}">{{$item->message}} {{$item->name}}</a></li>
                        @endforeach
                    </ul>
                </div>
    ...
    <div class="modal fade" id="exampleModal" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content bg-dark">
                ...
                <div class="fs-17">
                    <a class="dropdown-item text-light mt-4 ho-ac" href="{{url('/c_dashboard')}}">
                ...
                <div class="fs-17">
                    <div class="dropdown-item text-light ho-ac" disabled>
                        ...
                        <ul><a class="dropdown-item text-light mt-2 ho-ac" href="{{url('/c_not_implemented')}}">
                                <img class="" src="{{asset('image/Jud.gif')}}"style="width:3px;height:3px">
                                <p class="ms-1 d-inline">ที่ยังไม่ได้ดำเนินการ</p>
                            </a>
                            <a class="dropdown-item text-light mt-2 ho-ac" href="{{url('/c_implemented')}}">
                                <img class="" src="{{asset('image/Jud.gif')}}"style="width:3px;height:3px">
                                <p class="ms-1 d-inline">ที่ดำเนินการแล้ว</p>
                            </a>
                        </ul>
                </div>
                <hr class="dropdown-divider bg-light mt-3 mb-3">
