...
<div class="col-sm-12">
    <div class="p-1 ps-2 pe-2">
        <div class="clearfix pb-2 fs-17 f-weight">
            ...
            @foreach($data as $t)     
            <div class="float-end">
                <a onclick="return confirm('คุณต้องการยกเลิกข้อมูลร้องเรียนนี้หรือไม่ ?')" href="{{url('/delete_complaint',$t->id_complaint)}}"><button class="btn btn-danger btn-sm">ยกเลิก</button></a>
            </div>
        </div>    
